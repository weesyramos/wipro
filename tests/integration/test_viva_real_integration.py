...
def test_vivareal_integration(client, main_url_viva_real):
    ...
    assert res.get('totalCount') == 611
    assert len(res.get('listings')) == 10

def test_vivareal_integration_with_page_number(client, main_url_viva_real):
...
def test_vivareal_integration_with_per_page(client, main_url_viva_real):
...
def test_vivareal_integration_with_per_page_and_page_number(client, main_url_viva_real):
